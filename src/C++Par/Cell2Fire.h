...
class Cell2Fire {
    ...
    public: 
		...
		std::vector<std::unordered_map<int, vector<int>>> SendMessages();
		void GetMessages(std::vector<std::unordered_map<int, vector<int>>> sendMessageList);
		void Results();
		void outputGrid();
		void updateWeather();
